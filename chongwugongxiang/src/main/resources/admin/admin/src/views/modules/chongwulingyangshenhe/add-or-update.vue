        ...
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='chongwulingyang'">
                    <el-form-item class="select" v-if="type!='info'"  label="宠物寄养" prop="chongwulingyangId">
                        <el-select v-model="ruleForm.chongwulingyangId" filterable placeholder="请选择宠物寄养" @change="chongwulingyangChange">
                            <el-option
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   chongwulingyangId: [
                              { required: true, message: '宠物寄养不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
